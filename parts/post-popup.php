...
<div class="content post">
    <div class="post-card">
        ...
        <div>
            ...
            <span class="post-date pull-right">2018-7-20 12:11</span>
        </div>
        <div class="post-detail">
            <p>这是一个段落这是一个段落这是一个段落这是一个段落这是一个
                段落这是一个段落这是一个段落这是一个段落这是一个段落这是
                一个段落这是一个段落这是一个段落这是一个段落
            </p>
            <p>这是一个段落这是一个段落这是一个段落这是一个段落这是一个
                段落这是一个段落这是一个段落这是一个段落这是一个段落这是
                一个段落这是一个段落这是一个段落这是一个段落
...
<nav class="bar bar-tab post-textarea no-display">
    <div class="post-comment-submit-bar">
        <a href="#" class="pull-left cancel">取消</a>
        <a href="#" class="pull-right submit">发送</a>
    </div>
